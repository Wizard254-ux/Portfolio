      ...
      <div className=" pb-12 md:pt-16 md:pb-48">
        ...
        <div className="flex flex-col space-y-10 items-stretch justify-center align-top md:flex-row md:text-left md:p-4 md:space-y-0 md:space-x-10">
          <div className="md:w-1/2">
            ...
            <p>
              {""}
              Hi, my name is Kevin Omwoyo and Im a
            ...
            <br />
            <p>
              I graduated from Jomo Kenyatta University of Agriculture And Technology  Of Kenya in Nairobi, with a BS in Computer Science with a Second class upper
              division and have been working in the field ever since.
            </p>
            <br />
            <p>
              I have a wide range of hobbies and passions that keep me busy.
              From Prototyping, Developement, to deployment, I am
